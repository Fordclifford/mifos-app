...
import org.lspl.mobile.presenters.ClientIdUploadPresenter
 ...
 */
class ClientIdUploadFragment(clientId: Long) : BaseFragment(), ClientIdUploadView {

    @JvmField
    @BindView(R.id.id_front_choose_cust)
    var buttonChooseFront: Button? = null


    @JvmField
    @BindView(R.id.choose_id_back_cust)
    var buttonChooseBack: Button? = null


    @JvmField
    @BindView(R.id.id_view_front_cust)
    var imageViewFront: ImageView? = null

    @JvmField
    @BindView(R.id.id_view_back_cust)
    var imageViewBack: ImageView? = null

    @JvmField
    @BindView(R.id.btn_upload_cust_id)
    ...
    @OnClick(R.id.id_front_choose_cust)
    fun openFilePicker() {
        checkPermissionAndRequestFront()
    }

    @OnClick(R.id.choose_id_back_cust)
    ...
    companion object {
        fun newInstance(clientId: Long): ClientIdUploadFragment {
            return ClientIdUploadFragment(clientId)
        }
    }
